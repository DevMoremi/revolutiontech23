            ...
            <Reveal key={p.title} delay={idx * 120} as="article">
              <div className="group overflow-hidden rounded-xl bg-white shadow-card ring-1 ring-black/5 transition duration-300 hover:-translate-y-1.5 hover:shadow-2xl">
                ...
                <div className="p-5 sm:p-6">
                  <span className="inline-flex items-center rounded-md bg-brand-orange/15 px-3 py-1 text-xs font-semibold text-brand-orange">
                    {p.category}
                  </span>
                  ...
                  <a
                    href="#enroll"
                    className="mt-5 inline-flex w-full items-center justify-center rounded-md bg-brand-cyan py-3 text-sm font-semibold text-brand-purple-deep transition hover:scale-[1.02] hover:brightness-110 active:scale-95 sm:w-auto sm:px-8"
                  >
                    Enroll Now
                  </a>
                </div>
